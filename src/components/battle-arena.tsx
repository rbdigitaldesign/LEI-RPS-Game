        ...
        <div className="flex flex-col items-center justify-center gap-2 text-center my-0 mx-4">
          ...
          {!reveal && !match.isBye && (
            <Button
              ...
              className="w-24 h-24 rounded-full text-sm font-black tracking-tighter border-4 border-primary-foreground animate-pulse hover:animate-none disabled:animate-none"
            >
              {isProcessing ? '...' : 'BATTLE'}
            </Button>
          )}
